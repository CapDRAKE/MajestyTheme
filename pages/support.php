<section id="support" class="welcome-section">
    <div class="container">

        <div>
            <p class="lead">Bienvenue sur le support, vous retrouverez ici tous les tickets ouverts, vous pouvez vous-même en ouvrir un si vous avez souci, ou une question.</p>
            <hr class="my-4">
            <p>Une fois que votre ticket a été ouvert, vous pouvez aussi le fermer, ou y répondre en y apportant de plus amples informations.</p><br/><br/>
            ...
            <center><button class="theme-btn btn-style-one" data-toggle="collapse" href="#openticket" role="button" aria-expanded="false" aria-controls="openticket"><span class="btn-title">
                <i class="fas fa-pen-square"></i> Ouvrir un ticket
				</span></button></center><br/><br/>
                ...
                <div>
                    <form action="index.php?action=post_ticket" method="post">
                        ...
                        <div class="card-footer text-center">
                            <center><button type="submit" class="theme-btn btn-style-one"><span class="btn-title"><i class="fas fa-paper-plane"></i> Envoyer</span></button></center>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div style="display:inline-block;">
            <h4>Tickets créés <i class="fas fa-ticket-alt"></i></h4>
        ...
        <table class="table table-striped mt-4">
            <thead>
                <tr>
                    ...
                    <th scope="col"><i class="fas fa-eye"></i> Visibilité</th>
                    <?php endif; ?>
                    <th scope="col"><i class="fas fa-fingerprint"></i> Pseudo</th>
                    <th scope="col"><i class="fas fa-heading"></i> Titre</th>
                    <th scope="col"><i class="fas fa-calendar"></i> Date</th>
                    <th scope="col"><i class="fas fa-tools"></i> Action</th>
                    <th scope="col"><i class="fas fa-lightbulb"></i> Statut</th>
                    <?php if (Permission::getInstance()->verifPerm('PermsDefault', 'support', 'closeTicket')) : ?>
                    <th scope="col"><i class="fas fa-feather"></i> Modification</th>
                    <?php endif; ?>
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="no-hover">
                    ...
                    <td class="align-middle">
                        <a class="btn btn-primary btn-sm rounded" data-toggle="modal" data-target="#slide-<?= $tickets['id']; ?>" data-dismiss="modal">
